...
//	// }}}
	 ...
	 * @return  none
	 */
	public function addURIMappingFieldsToEditCategoryForm($category_id, $dividerClass = ['label' => 'col-sm-3 control-label', 'input_field'=>'col-sm-9 col-md-6'])
	{
		global $contents;
	 ...
	 * @return  string    The source for the input fields.
	 */
	public function buildCategoryURIMappingFormFields($prev_uri_mappings, $dividerClass = ['label' => 'col-sm-3 control-label', 'input_field'=>'col-sm-9 col-md-6'])
	{
		global $languages;
