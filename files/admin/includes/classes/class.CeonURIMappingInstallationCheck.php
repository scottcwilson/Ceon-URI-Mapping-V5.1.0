...
class CeonURIMappingInstallationCheck extends CeonURIMappingVersion
{
	 ...
	 * @access  protected
	 */
	protected $_config_files_error_messages = [];
	 ...
	 * @access  protected
	 */
	protected $_modified_core_files_error_messages = [];
	 ...
	 * @access  protected
	 */
	protected $_old_files_dirs_error_messages = [];
	...
	protected function _checkConfigureFilesSettings()
	{
		...
		if (!defined('DIR_WS_CATALOG') || strlen(DIR_WS_CATALOG) == 0) {
		...
		} elseif (DIR_WS_CATALOG != '/' && (substr(DIR_WS_CATALOG, 0, 1) != '/'
			...
			} elseif (substr(DIR_WS_CATALOG, 0, 1) != '/') {
				$error_message['extra_desc'] = [
			...
			} elseif (substr(DIR_WS_CATALOG, -1) != '/') {
				$error_message['extra_desc'] = [
		...
		if (!defined('DIR_WS_HTTPS_CATALOG') || strlen(DIR_WS_HTTPS_CATALOG) == 0) {
		...
		} elseif (DIR_WS_HTTPS_CATALOG != '/' && (substr(DIR_WS_HTTPS_CATALOG, 0, 1) != '/'
			...
			} elseif (substr(DIR_WS_HTTPS_CATALOG, 0, 1) != '/') {
				$error_message['extra_desc'] = [
			...
			} elseif (substr(DIR_WS_HTTPS_CATALOG, -1) != '/') {
				$error_message['extra_desc'] = [
		...
		foreach ($core_file_modifications as $core_file_modification) {
			...
			for ($i = 0, $n = (isset($core_file_modification['new_snippets']) ? sizeof($core_file_modification['new_snippets']) : 0); $i < $n; $i++) {
				...
				if ($snippet_start_line_pos !== false &&
					...
					$offset = $snippet_end_line_pos + (!empty($snippet_end_line) ? strlen($snippet_end_line) : 0);
